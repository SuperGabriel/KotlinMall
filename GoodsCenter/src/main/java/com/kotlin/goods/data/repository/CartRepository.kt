...
class CartRepository @Inject constructor() {
    ...
    fun getCartList(): Observable<BaseResp<MutableList<CartGoods>?>> {
        return RetrofitFactory.create(CartApi::class.java).getCartList()
    }
    ...
    fun addCart(
        ...
        return RetrofitFactory.create(CartApi::class.java)
    ...
    fun deleteCartList(list: List<Int>): Observable<BaseResp<String>> {
        return RetrofitFactory.create(CartApi::class.java).deleteCartList(DeleteCartReq(list))
    }
    ...
    fun submitCart(list: MutableList<CartGoods>, totalPrice: Long): Observable<BaseResp<Int>> {
        return RetrofitFactory.create(CartApi::class.java).submitCart(SubmitCartReq(list, totalPrice))
    }
